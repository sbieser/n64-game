...
A gas giant with a ring system spanning hundreds of thousands of kilometers. The rings are not decoration — they are debris. A moon crossed the Roche limit, the distance at which the planet's tidal forces exceed the moon's own gravity, and was torn apart. What was once a world is now a field of ice and rock in perfect orbital resonance, slowly grinding itself smaller over millions of years.
...
## Seeking — Visual Gravitational Lensing

The Colossus is massive enough to bend light. Stars behind it appear distorted — arced, stretched, curved. The player looks for the region of sky where stars are behaving wrongly and orients toward it.

The rings complicate this: ring geometry also distorts the visual field. The player must distinguish lensing distortion (smooth arc, consistent curve) from ring parallax and particle scatter (irregular, patchy, local). The Colossus's lensing is the one thing in the field that is perfectly geometrically consistent.

See `mechanics/seeking_mechanic.md` for the visual lensing mechanic.
